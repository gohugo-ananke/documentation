...
tools:
  - search/fileSearch
description: Generate beginner-friendly technical documentation for a Hugo theme feature introduced by a PR and (optionally) an Issue, using repository context.
---

# PR documentation generator for Hugo theme features

This document defines a normative procedure for generating user-facing documentation for Hugo theme features introduced by a PR/MR and, optionally, an Issue.
...
* The term **Hugo** MUST be used consistently.
...
* Horizontal rules (`---`) MUST NOT be used as style separator in documentation content.
...
* Minimum Hugo version, if implied.
...
When Hugo internals are involved, the assistant MUST link to the most specific relevant page on https://Hugo.io.
